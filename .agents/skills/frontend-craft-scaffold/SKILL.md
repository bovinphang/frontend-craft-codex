...
description: 按项目规范创建 page、feature 或 component 的标准目录结构和样板文件。当用户要求创建页面、功能模块、组件脚手架时自动激活。用法示例：创建 UserDetail 页面、创建 payment 功能、创建 DataTable 组件。
---
...
```
用法示例：
  - 创建 UserDetail 页面（page UserDetail）
  - 创建 payment 功能（feature payment）
  - 创建 DataTable 组件（component DataTable）
```
